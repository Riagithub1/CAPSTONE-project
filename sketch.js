...
function preload()
{
  ...
  half = loadAnimation('one_star.png');
  full = loadAnimation('stars.png');
...
function setup() 
{
  ...
  //star 1
  star1 = createSprite(320,70,80,80);
  star1.addImage(starimg);
  star1.scale = 0.04;
  //star 2
  star2 = createSprite(110,300,80,80);
  star2.addImage(starimg);
  star2.scale = 0.04;

  //star counter :)
  starcounter = createSprite(70,50,80,80);
  starcounter.scale = 0.3;
  starcounter.addAnimation('nada',empty);
  starcounter.addAnimation('one',half);
  starcounter.addAnimation('both',full);
  starcounter.changeAnimation('nada');
...
function draw() 
{
  ...
  {
    star1.visible = false;
    starcounter.changeAnimation('one');
  }

  if (collide(fruit,star2,20)==true) 
  {
    star2.visible = false;
    starcounter.changeAnimation('both');
  }
}
